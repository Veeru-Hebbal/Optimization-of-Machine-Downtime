...
autoML_file = 'autoML_pipeline_best'
...
Hydraulic_Pressure__bar = st.number_input('Hydraulic_Pressure__bar', value=101.4, min_value=00.0, max_value=200.0, step=0.1, format='%f')
Coolant_Pressure__bar = st.number_input('Coolant_Pressure__bar', value=4.95, min_value=0.00, max_value=15.0, step=0.1, format='%f')
Air_System_Pressure__bar = st.number_input('Air_System_Pressure__bar', value=6.50, min_value=0.0, max_value=10.0, step=0.1, format='%f')
Coolant_Temperature__deg_cel = st.number_input('Coolant_Temperature__deg_cel', value=18.56, min_value=0.0, max_value=100.0, step=0.1, format='%f')
Hydraulic_Oil_Temperature__deg_cel = st.number_input('Hydraulic_Oil_Temperature__deg_cel', value=47.62, min_value=0.0, max_value=100.0, step=0.1, format='%f')
Spindle_Bearing_Temperature__deg_cel = st.number_input('Spindle_Bearing_Temperature__deg_cel', value=35.06, min_value=0.0, max_value=100.0, step=0.1, format='%f')
Spindle_Vibration__Microm = st.number_input('Spindle_Vibration__Microm', value=1.01, min_value=0.01, max_value=3.00, step=0.01, format='%f')
Tool_Vibration__Microm = st.number_input('TTool_Vibration__Microm', value=25.41, min_value=0.0, max_value=100.0, step=0.1, format='%f')
Spindle_Speed__RPM = st.number_input('Spindle_Speed__RPM', value=20274, min_value=00, max_value=30000, step=1, format='%d')
Voltage__volts = st.number_input('Voltage__volts', value=349, min_value=200, max_value=480, step=10, format='%d')
Torque__Nm = st.number_input('Torque__Nm', value=25.23, min_value=0.0, max_value=60.0, step=0.1, format='%f')
Cutting__kN = st.number_input('Cutting__kN', value=2.78, min_value=0.0, max_value=5.0, step=0.1, format='%f')
